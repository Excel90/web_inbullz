        ...
        <div class="row">
            <div class="col-lg-12" style="padding: 0;">
                <video  playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop" id="header-video" style="
                        ...
                        left: 0;
                        object-fit: cover;">
                    <source src="asset\bg.webm"type="video/webm">
                </video>
                <div class="judul-mading">
                    <img src="asset/judul.png" alt="" class="hide" >
                    <a href="Inbullz.html" class="judul-mading-hover">
                ...
                <div class="butterfly ">
                    ...
                    <a class="butterfly-hover"　type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#butterfly-content">
                        <img src="asset/kupu-kupu_hover.gif" style="width: 25vw;position: absolute;left: 15vw; top: 2vw;" alt="">
                    </a>
                </div>
